...
#define X_HOMING_BUMP_MM 5
#define Y_HOMING_BUMP_MM 5
#define Z_HOMING_BUMP_MM 2
 ...
 */
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       310        // (mA) RMS current. Multiply by 1.414 for peak current.
